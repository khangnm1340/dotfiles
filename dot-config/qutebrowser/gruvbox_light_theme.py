# gruvbox light hard qutebrowser theme by Florian Bruhin <me@the-compiler.org>
#
# Originally based on:
...
def apply_gruvbox_light_theme(c):
...
# Font color for hints.
    c.colors.hints.fg = "#141311"

# Background color for hints.
    # c.colors.hints.bg = 'rgba(250, 191, 47, 200)'  # bright_yellow
    c.colors.hints.bg = "#00FFFF"
